...
public class InterfazEdiciones extends HttpServlet {
...
//  ControlExtraccion ce;
   ...
   public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
	...
	//out.println("							<li class=\"active\"><a href=\"Ediciones?tipo="+tipo+"\">Ediciones Anteriores</a></li>");
	...
	out.println("				</nav>		");
	out.println("				<H1 align=\"center\">Ediciones</H1>	");		
	out.println("			</BODY>");
	out.println("		</HTML>");
  }
}
