...
public class InterfazRevista extends HttpServlet {
  HttpServletResponse thisResponse;
  HttpServletRequest thisRequest;
  PrintWriter out;
  LeerRevista b = new LeerRevista();
   ...
   public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
	...
	out.println("							<li class=\"active\"><a href=\"Revista?tipo="+tipo+"\">Revista del Mes</a></li>");
	...
	out.println("						</ul>");
	out.println("						<form class=\"navbar-form navbar-left\" role=\"search\" action=\"Articulos?tipo="+tipo+"\" method=\"GET\">");
	...
	out.println("				</nav>		");
	out.println("				<H1 align=\"center\">Revista</H1>	");		
	out.println("	<H3 align=\"center\">Nota de interes</H3>");
	...
	NotaActualidad nt = b.notaEd(eid);
	
	if(nt != null) {
	out.println("					<tr>");	
	out.println("						<td>"+nt.titulo+"</td>");	
	out.println("						<td>"+nt.texto+"</td>");	
	out.println("					 </tr>");
	}
	...
	out.println("		<H3 align=\"center\">Articulos del mes</H3>");
	out.println("		<table class=\"table\">");
	out.println("		  <tr style=\"background-color:black; color:white;\">");
	out.println("			<td></td>");
	out.println("			<td>Titulo</td>");
	...
	Vector<Articulo> art = b.articulosAprobados(eid);
	int i=1;
	for(Articulo a : art)
	{
		out.println("					<tr>");
