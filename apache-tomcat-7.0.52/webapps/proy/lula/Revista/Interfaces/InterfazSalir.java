...
public class InterfazSalir extends HttpServlet {
  ...
  PrintWriter out;
   ...
   public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
	...
	out.println("						  <li class=\"active\"><a href=\"Salir?tipo="+tipo+"\">Cerrar Sesi&oacute;n</a></li>");
	out.println("						  <li><a href=\"RenovarSuscripcion?tipo="+tipo+"\">Renovar Suscripci&oacute;n</a></li>");
	out.println("						</ul>");
	out.println("				  </div><!-- /.navbar-collapse  -->");
	out.println("				</nav>		");
	out.println("				<script>");
	out.println("					var r=confirm(\"¿Esta seguro?\");");
	out.println("					if (r==true)");
	out.println("						window.location.replace('index.html');");
	out.println("					else");
	out.println("						window.location.replace('Revista?tipo="+tipo+"');");
	out.println("				</script>");
	out.println("				<H1 align=\"center\">Salir!</H1>	");		
	out.println("			</BODY>");
	out.println("		</HTML>");
  }
}
