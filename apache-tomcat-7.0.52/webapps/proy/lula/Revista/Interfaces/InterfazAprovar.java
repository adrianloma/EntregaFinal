...
//  ControlExtraccion ce;
   ...
   public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
	...
	out.println("							<li class=\"active\"><a href=\"Aprovar\">Aprovar Art&iacute;culos</a></li>");
	...
	out.println("				</nav>		");
	out.println("				<H1 align=\"center\">Aprovar!</H1>	");	


	out.println("				<form name=\"forma\" class=\"form-horizontal\" role=\"form\" action=\"Aprovar\" method=\"get\">");	
	...
	//Vector<Articulo> art = b.articulosAprovar();

	//for(Articulo a : art)
	//{
		out.println("					  <tr>");
	//  out.println("						<td><a href=\"Aprovar?id="+a.getId()+"\">"+Aprovar+"</a></td>");	
