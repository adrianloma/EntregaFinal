...
public class InterfazSugerir extends HttpServlet {
  ...
  String autores;
   ...
   public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
	...
	revista = request.getParameter("abstracto");
	autores = request.getParameter("autores");
	if(titulo == null && abstracto == null && revista == null && autores == null){
		...
		out.println("				</nav>		");
		out.println("				<H1 align=\"center\">Sugerir! (Terminado)</H1>	");		
		...
		out.println("					<div class=\"form-group\"><label for=\"inputEmail3\" class=\"col-sm-2 control-label\">Sugerir:</label><textarea name=\"articulo\" rows=\"5\" cols=\"50\" placeholder=\"Inserte Art&iacute;culo\"></textarea><button type=\"submit\" class=\"btn btn-default\">Enviar</button></div>");	
		out.println("				</form>");	
		out.println("			</BODY>");
		out.println("		</HTML>");
	 }else{
